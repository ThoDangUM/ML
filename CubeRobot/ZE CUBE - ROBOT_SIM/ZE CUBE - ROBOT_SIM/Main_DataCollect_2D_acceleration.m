...
%pause(10);
%
fileRobot = fopen('Robot_data_accel_01_06_22.txt','w');
fileID = fopen('Cm_Data_19_05_22.txt','r');
f_size = 194481;%2825761;
% read PWM value
...
%    ETAT = [X,];% x y psi u v r u_dot v_dot r_dot
    [ETAT_NEW,F_B_Effective,F_M_Effective,ACCEL_ef]=Modele_Dynamique_Integration_2D_acceleration(ETAT,Concentrateur,PWM,Dyn_Robot,Moteur,dt);
    Q_B_0 = ETAT_NEW(1:4);
...
%        ETAT_SAVE = [V_0(1), V_0(2), W_B(3)];% u v r
        ETAT_SAVE = ACCEL_ef;% u_dot, v_dot, r_dot
