...
%(1) AVG
Moteur(1).position = [dx -dy -dz];
Moteur(2).position = [dx dy -dz];
Moteur(3).position = [-dx dy -dz];
Moteur(4).position = [-dx -dy -dz];
Moteur(5).position = [0 -dy -dz];
Moteur(6).position = [0 dy -dz];
Moteur(7).position = [dx -dy dz];
Moteur(8).position = [dx dy dz];
Moteur(9).position = [-dx dy dz];
Moteur(10).position = [-dx -dy dz];
Moteur(11).position = [0 -dy dz];
Moteur(12).position = [0 dy dz];
...
save PARAM_Moteurs_ULYSSE Moteur Moteur_EST
...
save PARAM_Dyn_ULYSSE Dyn_Robot Dyn_Robot_EST
